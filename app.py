...
st.set_page_config(page_title="Projeto Inclua", page_icon="🧩", layout="wide")
...
with st.sidebar:
    ...
    nome_aluno = st.text_input("Nome do Aluno:", value="Ex: João Silva")
...
# Rodapé
st.divider()
st.caption("Protótipo do Projeto Integrador - Foco no Professor.")
